...
while ! docker exec ${db_container_id} mysql --user=root --password=root -e "CREATE DATABASE bagisto_testing CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci;" >/dev/null 2>&1; do
    sleep 1
done
